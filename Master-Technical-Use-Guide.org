...
1. Launch Dante Controller [[./.imagegit/dante-virtual-soundcard-logo-small.png]]
...
1. Launch Dante Virtual Soundcard application [[./.imagegit/DVS_Icon.png]]
...
2. Make sure Audio > Device is selected from the left-hand menu [[./.imagegit/reaper-audio-devices-tab.png]]
...
1. In Reaper, go to Options > Preferences (C+p) [[./.imagegit/reaper-options.png]]

2. Make sure Audio > Device is selected from the left-hand menu [[./.imagegit/reaper-audio-devices-tab-numbered.png]]
...
1. In Max msp, go to Options > Audio Status [[./.imagegit/max-audio-status.png]]
